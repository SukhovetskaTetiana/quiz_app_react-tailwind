...
export default function Header() {
  ...
  const h1Classes =
    "text-[2.5rem] tracking-[0.6rem] m-0 uppercase bg-gradient-to-r from-pinkLight-400 from-[40%] via-blau-200 via-[60%] webkit-background-clip webkit-text-fill-color";
